  ...
  <div class="container mt-5 mb-5"> <!-- Kontainer Bootstrap dengan margin atas dan bawah 5 unit -->
    <form> <!-- Elemen formulir untuk input data -->
      <div class="col-sm-3 mb-3"> <!-- Elemen formulir dengan margin bawah 3 unit -->
      ...
      <div class="col-sm-3 mb-3"> <!-- Elemen formulir dengan margin bawah 3 unit -->
        <label for="customer" class="form-label">Nama Supplier</label> <!-- Label untuk input nama supplier -->
        <input type="text" class="form-control" id="customer" placeholder="Nama Supplier"> <!-- Input nama supplier -->
      </div>
      <div class="col-sm-3 mb-3"> <!-- Elemen formulir dengan margin bawah 3 unit -->
        <label for="hp" class="form-label">CP Supplier</label> <!-- Label untuk input nomor handphone -->
        <input type="number" class="form-control" id="hp" placeholder="CP Supplier"> <!-- Input nomor handphone -->
      </div>
      <div class="col-sm-3 mb-3"> <!-- Elemen formulir dengan margin bawah 3 unit -->
        <label for="alamat" class="form-label">Alamat Supplier</label> <!-- Label untuk input keterangan -->
        <input type="text" class="form-control" id="alamat" placeholder="Alamat Supplier"> <!-- Input keterangan -->
      </div>
    </form>
  </div>
  ...
  <div class="container mt-5 mb-5"> <!-- Kontainer Bootstrap dengan margin atas dan bawah 5 unit -->
    <div class="row"> <!-- Baris Bootstrap untuk mengatur tata letak kolom -->
      ...
      <div class="col-sm-2"><button class="btn btn-primary btn-sm" id="tambah">Tambah</button></div>
    ...
    <table class="table"> <!-- Tabel untuk menampilkan data barang -->
      ...
      <tfooter>
        ...
        <tr>
          <td colspan="6" class="text-end align-items-center">Bayar</td>
          <!-- Colspan untuk menggabungkan 6 kolom menjadi satu -->
